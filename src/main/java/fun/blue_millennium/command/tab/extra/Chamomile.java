package fun.blue_millennium.command.tab.extra;

import fun.blue_millennium.command.tab.Completer;
import fun.blue_millennium.command.tab.extra.sub.Config;
import fun.blue_millennium.command.tab.extra.sub.Data;
import fun.blue_millennium.command.tab.extra.sub.Kill;
 ...
 */
public class Chamomile extends Completer {
    public Chamomile() {
        super("chamomile");
    }
