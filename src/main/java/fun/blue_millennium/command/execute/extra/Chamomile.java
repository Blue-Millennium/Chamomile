package fun.blue_millennium.command.execute.extra;

import fun.blue_millennium.command.execute.Executor;
import fun.blue_millennium.command.execute.extra.sub.*;
import fun.blue_millennium.command.execute.extra.sub.report.Report;
import fun.blue_millennium.command.execute.extra.sub.report.ReportQuery;
 ...
 */
public class Chamomile extends Executor {
