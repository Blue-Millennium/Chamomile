package fun.blue_millennium.command.execute.extra.sub.data;

import fun.blue_millennium.command.execute.Executor;
import fun.blue_millennium.command.execute.extra.sub.data.query.DataQueryByName;
import fun.blue_millennium.command.execute.extra.sub.data.query.DataQueryByQQ;
import fun.blue_millennium.command.execute.extra.sub.data.query.DataQueryByUUID;
import fun.blue_millennium.command.execute.extra.sub.data.query.DataQueryByUserID;
...
public class Query extends Executor {
