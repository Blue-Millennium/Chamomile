package fun.blue_millennium.command.execute.othercommands.sub.data.query;
...
import static fun.blue_millennium.command.execute.othercommands.sub.data.query.DataQueryByQQ.LongProcess;
