package fun.blue_millennium.command.execute.othercommands.sub.data;

import fun.blue_millennium.command.execute.othercommands.sub.data.query.DataQueryByName;
import fun.blue_millennium.command.execute.othercommands.sub.data.query.DataQueryByQQ;
import fun.blue_millennium.command.execute.othercommands.sub.data.query.DataQueryByUUID;
import fun.blue_millennium.command.execute.othercommands.sub.data.query.DataQueryByUserID;
