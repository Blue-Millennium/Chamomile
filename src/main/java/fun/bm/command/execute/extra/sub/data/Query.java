package fun.bm.command.execute.extra.sub.data;

import fun.bm.command.execute.Executor;
import fun.bm.command.execute.extra.sub.data.query.DataQueryByName;
import fun.bm.command.execute.extra.sub.data.query.DataQueryByQQ;
import fun.bm.command.execute.extra.sub.data.query.DataQueryByUUID;
import fun.bm.command.execute.extra.sub.data.query.DataQueryByUserID;
