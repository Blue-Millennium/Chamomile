package fun.bm.command.execute.extra.sub;

import fun.bm.command.execute.Executor;
import fun.bm.command.execute.extra.sub.config.Query;
import fun.bm.command.execute.extra.sub.config.Reload;
import fun.bm.command.execute.extra.sub.config.Set;
 ...
 */
public class Config extends Executor {
