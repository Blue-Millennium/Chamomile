package fun.bm.command.modules.executor.extra;

import fun.bm.command.Command;
import fun.bm.command.modules.executor.extra.sub.*;
import fun.bm.command.modules.executor.extra.sub.report.Report;
import fun.bm.command.modules.executor.extra.sub.report.ReportDelete;
import fun.bm.command.modules.executor.extra.sub.report.ReportQuery;
