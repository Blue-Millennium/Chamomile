package fun.bm.command.modules.executor.extra.sub.data;

import fun.bm.command.Command;
import fun.bm.command.modules.executor.extra.sub.data.query.DataQueryByName;
import fun.bm.command.modules.executor.extra.sub.data.query.DataQueryByQQ;
import fun.bm.command.modules.executor.extra.sub.data.query.DataQueryByUUID;
import fun.bm.command.modules.executor.extra.sub.data.query.DataQueryByUserID;
