package fun.bm.command.modules.executor.extra.sub.data.query;

import fun.bm.command.Command;
import fun.bm.command.modules.executor.extra.sub.data.Query;
import org.bukkit.command.CommandSender;
import org.jetbrains.annotations.NotNull;

import static fun.bm.command.modules.executor.extra.sub.data.query.DataQueryByQQ.longProcess;
