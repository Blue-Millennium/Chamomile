...
import fun.bm.chamomile.command.modules.extra.sub.config.Query;
import fun.bm.chamomile.command.modules.extra.sub.config.Reload;
import fun.bm.chamomile.command.modules.extra.sub.config.Set;
 ...
 */
public class Config extends ExtraCommand implements CommandExecutor, TabCompleter {
