...
import fun.bm.chamomile.command.modules.extra.sub.data.List;
...
public class Data extends ExtraCommand implements CommandExecutor, TabCompleter {
    ...
    public java.util.List<String> onTabComplete(@NotNull CommandSender sender, @NotNull org.bukkit.command.Command command, @NotNull String label, @NotNull String[] args) {
